...
import YellowBall from "../assets/yellow.png";
import GreenBall from "../assets/green.png";
import BrownBall from "../assets/brown.png";
import BlueBall from "../assets/blue.png";
import PinkBall from "../assets/pink.png";
import BlackBall from "../assets/black.png";
...
export class Game {
  ...
  fall(playerId) {
    ...
    this.history.push({ type: "fall", player });
  }
  ...
  undo() {
    ...
    if (!play) return;
    this.history.push({ type: "undo", play });
